        ...
        child: Container(
          ...
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                        ...
                        child: Icon(LineAwesomeIcons.alternate_pencil, size: 20.0, )),
                  )
                ],
              ),
              SizedBox(height: 10,),
              Text(tProfileHeading, style: Theme.of(context).textTheme.headlineSmall,),
              Text(tProfileSubHeading, style: Theme.of(context).textTheme.headlineSmall),
              SizedBox(height: 20),
              SizedBox(width: 200,
                child: ElevatedButton(onPressed: () => Get.to(() => UpdateProfileScreen())
              ...
              SizedBox(height: 10),
              ProfileMenuWidget(title: 'Logout',textColor: Colors.red ,icon: LineAwesomeIcons.alternate_sign_out,
                onPress: () {
